...
public class MPermissionUtils {
    ...
    public static final int WRITE_EXTERNAL_STORAGE = 400;
     ...
     * 请求权限处理
     *
     * @param object      activity_mysubmit_location or fragment
        ...
        new AlertDialog.Builder(context)
                ...
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //context转换为activity
//                        Activity activity_mysubmit_location = (Activity) context;
//                        activity_mysubmit_location.finish();
     ...
     * 检查所传递对象的正确性
     *
     * @param object 必须为 activity_mysubmit_location or fragment
     */
...
//                if (PermissionChecker.checkPermission(context, permission, Process.myPid(),
//                        Process.myUid(), "com.runachina.heatingmonitor") == PackageManager.PERMISSION_DENIED) {
//                    Log.e("lyl", "checkPermissions: ");
//                    return false;
//                }
